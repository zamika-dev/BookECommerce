...
namespace SampleStore.DataAccess.Migrations
{
    ...
    [Migration("20250801212430_addOrderAndOrderDetail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SampleStore.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SampleStore.Domain.Entities.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SampleStore.Domain.Entities.OrderDetail", b =>
                {
                    ...
                    b.HasOne("SampleStore.Domain.Entities.Order", "Order")
                        .WithMany()
